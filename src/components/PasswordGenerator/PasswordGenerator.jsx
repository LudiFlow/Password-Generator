...
export default function PasswordGenerator() {
  function generatePassword() {
    ...
    Password(optionsArray, document.getElementById("range-slider").value);
  }
    ...
    <div>
      ...
      <div className="card-bottom card-background-dark-grey">
        <div className="column">
          ...
          />
          <div id="options">
            <Button desc={"Include Uppercase Letters"} id={1} />
            <Button desc={"Include Lowercase Letters"} id={2} />
            <Button desc={"Include Numbers"} id={3} />
            <Button desc={"Include Symbols"} id={4} />
          </div>
